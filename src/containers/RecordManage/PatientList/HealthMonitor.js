		...
		return(
			<div>
				...
				<Tabs defaultActiveKey="1" >
				    ...
				    <TabPane tab="体温监测" key="3">体温检测</TabPane>
				    <TabPane tab="体重监测" key="4">体重监测</TabPane>
				    <TabPane tab="心率监测" key="5">心率监测</TabPane>
				    <TabPane tab="尿酸监测" key="6">尿酸监测</TabPane>
				    <TabPane tab="血脂监测" key="7">血脂监测</TabPane>
